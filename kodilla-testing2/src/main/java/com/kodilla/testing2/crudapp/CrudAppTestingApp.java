...
public class CrudAppTestingApp {
    ...
    public static void main(String[] args) {
        ...
        driver.get("https://danielmisior.github.io/");

        WebElement searchField = driver.findElement(By.xpath(XPATH_INPUT));
        searchField.sendKeys("New robotic task");

        WebElement textereaField = driver.findElement(By.xpath(XPATH_TEXTAREA));
        textereaField.sendKeys("The robotic content");

        while (!driver.findElement(By.xpath(XPATH_WAIT_FOR)).isDisplayed());

        WebElement selectCombo = driver.findElement(By.xpath(XPATH_WAIT_FOR));
