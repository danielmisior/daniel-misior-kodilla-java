...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://danielmisior.github.io/";
    ...
    private void sendTestTaskToTrello(String taskName) throws InterruptedException {
        ...
        driver.findElements(
                ...
                .forEach(theForm -> {
                    ...
                    Select selectedList = new Select(selectList);
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("daniel.misior09@gmail.com");
        driverTrello.findElement(By.id("password")).sendKeys("Tajne123");
